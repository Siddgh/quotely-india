...
import kotlinx.android.synthetic.main.layout_quotes_list.view.*
...
class TagsListAdapter(
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int, model: QuotesMeta) {
        holder.itemView.apply {
            tv_layout_quotes_list_quote.text = model.quotes.quote()
            tv_layout_quotes_list_likes.text = StringUtils.displayLikes(model.likes)
            tv_layout_quotes_list_tag.text = model.tag[0]
            tv_layout_quotes_list_from.text = model.movie
            ...
            FirebaseDatabaseUtils.userDatabaseReference.child(
                ...
                .addListenerForSingleValueEvent(object : ValueEventListener {
                    ...
                    override fun onDataChange(p0: DataSnapshot) {
                        if (p0.exists()) {
                            iv_layout_quotes_list_likes.setImageResource(R.drawable.ic_fav_filled)
                        } else {
                            iv_layout_quotes_list_likes.setImageResource(R.drawable.ic_fav)
                        }
