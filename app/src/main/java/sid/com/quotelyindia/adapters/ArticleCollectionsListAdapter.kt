...
class ArticleCollectionsListAdapter(
    options: DatabasePagingOptions<TagsListModel>,
    private val activity: Activity,
    private val supportFragmentManager: FragmentManager,
    private val isQuoteCard: Boolean
) :
    FirebaseRecyclerPagingAdapter<TagsListModel, ArticleCollectionsListAdapter.ViewHolder>(options) {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int, model: TagsListModel) {
        FirestoreUtils.getLikedQuotesFirestoreReference(isQuoteCard).document(model.name ?: "")
            .get()
